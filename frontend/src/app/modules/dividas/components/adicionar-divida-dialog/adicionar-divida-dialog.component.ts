...
export class AdicionarDividaDialogComponent implements OnInit, OnDestroy {
  readonly tipos = TIPOS_DIVIDA_OPCOES;
  ...
  get tituloDialog(): string {
    return this.isEdicao ? 'Editar dívida' : 'Adicionar dívida';
  }
  ...
  constructor(
    ...
    this.form = this.fb.group({
      ...
      statusDivida: ['pagando', Validators.required],
