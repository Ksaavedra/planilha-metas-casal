# Script para deploy usando ESBuild nativo do Serverless
# Esta é a solução mais eficiente e moderna

Write-Host "⚡ Deploy Lambda com ESBuild Nativo" -ForegroundColor Green
...
Write-Host ""
Write-Host "⚡ Fazendo deploy com ESBuild nativo..." -ForegroundColor Cyan
Write-Host "ESBuild é muito mais rápido e eficiente!" -ForegroundColor Yellow
...
if ($LASTEXITCODE -eq 0) {
    ...
    Start-Sleep -Seconds 15  # Aguardar inicialização
    try {
