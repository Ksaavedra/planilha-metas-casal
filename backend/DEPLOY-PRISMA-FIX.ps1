# Script para fazer deploy com correção do Prisma
# Este script corrige o problema do Prisma Client no Lambda

Write-Host "🔧 Deploy Lambda com correção do Prisma..." -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "🔧 Copiando arquivos do Prisma para o pacote..." -ForegroundColor Cyan

# Criar diretório temporário para o pacote
$PackageDir = ".serverless"
